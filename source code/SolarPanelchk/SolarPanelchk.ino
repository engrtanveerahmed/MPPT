...
#define ENABLE_VOLTAGE 15.0
#define DISABLE_VOLTAGE 13.0
#define INPUT_TARGET_VOLTAGE 14.5
#define OUTPUT_TARGET_VOLTAGE_LOW 12.0
#define OUTPUT_TARGET_VOLTAGE_HIGH 12.2
#define INPUT_CURRENT_LIMIT 2000.0
#define OUTPUT_CURRENT_LIMIT 3000.0
#define INPUT_CURRENT_MINIMUM 0.0
...
void setup()
{
  ...
  lcd.begin(16, 2);
  lcd.setCursor(0, 0);
  lcd.print(" Tanveer & Habib");
  lcd.setCursor(0, 1);
  lcd.print(" SIBAU FABLAB ");
